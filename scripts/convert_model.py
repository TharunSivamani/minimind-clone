...
def convert_torch2transformers_minimind(torch_path, transformers_path, dtype=torch.float16):
    ...
    print(f"Model has been saved in Transformers-MiniMind format: {transformers_path}")
...
def convert_torch2transformers_llama(torch_path, transformers_path, dtype=torch.float16):
    ...
    print(f"Model has been saved in Transformers-Llama format: {transformers_path}")
...
def convert_transformers2torch(transformers_path, torch_path):
    ...
    print(f"Model has been saved in PyTorch format: {torch_path}")
